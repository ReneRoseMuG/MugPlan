  ...
  appointments: {
    ...
    delete: {
      ...
      responses: {
        ...
        403: z.object({ code: z.literal("PAST_APPOINTMENT_READONLY") }),
        404: errorSchemas.notFound,
        409: z.object({ code: z.enum(["VERSION_CONFLICT", "PAST_APPOINTMENT_READONLY", "CANCELLED_APPOINTMENT_READONLY", "PLANNING_BLOCKED_APPOINTMENT_READONLY"]) }),
        422: z.object({ code: z.literal("VALIDATION_ERROR") }),
      },
    },
    setDisplayMode: {
    ...
    park: {
      ...
      responses: {
        ...
        403: z.object({ code: z.literal("FORBIDDEN") }),
        404: errorSchemas.notFound,
        409: z.object({ code: z.enum(["VERSION_CONFLICT", "PAST_APPOINTMENT_READONLY", "CANCELLED_APPOINTMENT_READONLY", "PLANNING_BLOCKED_APPOINTMENT_READONLY", "ALREADY_PARKED", "BUSINESS_CONFLICT"]) }),
        422: z.object({ code: z.literal("VALIDATION_ERROR") }),
      },
    },
    tourChangePreview: {
  ...
  appointmentTags: {
    ...
    add: {
      ...
      responses: {
        ...
        403: z.object({ code: z.literal("FORBIDDEN") }),
        404: errorSchemas.notFound,
        409: z.object({ code: z.enum(["PAST_APPOINTMENT_READONLY", "CANCELLATION_TAG_PROTECTED", "CANCELLED_APPOINTMENT_READONLY", "PLANNING_BLOCKED_APPOINTMENT_READONLY"]) }),
        422: z.object({ code: z.literal("VALIDATION_ERROR") }),
      },
    },
    remove: {
      ...
      responses: {
        ...
        403: z.object({ code: z.literal("FORBIDDEN") }),
        404: errorSchemas.notFound,
        409: z.object({ code: z.enum(["VERSION_CONFLICT", "PAST_APPOINTMENT_READONLY", "CANCELLATION_TAG_PROTECTED", "CANCELLED_APPOINTMENT_READONLY", "PLANNING_BLOCKED_APPOINTMENT_READONLY"]) }),
        422: z.object({ code: z.literal("VALIDATION_ERROR") }),
      },
    },
  },
