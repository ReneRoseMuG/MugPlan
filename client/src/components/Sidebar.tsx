      ...
      <nav className="flex flex-col flex-1">
        ...
        {isAdmin && (
          <NavGroup title="Administration">
            <NavButton icon={Boxes} label="Stammdaten" isActive={currentView === 'masterData' || currentView === 'projectStatus' || currentView === 'noteTemplates'} onClick={() => onViewChange('masterData')} />
