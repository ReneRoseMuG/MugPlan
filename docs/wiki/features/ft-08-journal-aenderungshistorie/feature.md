...
Dieses Feature stellt eine lesbare, filterbare und kontextbezogene Änderungshistorie für fachlich relevante Daten bereit. Angemeldete Benutzer mit Leseberechtigung sollen nachvollziehen können, welche Änderungen an Kunden, Projekten und Terminen vorgenommen wurden, von wem sie ausgelöst wurden und in welchem fachlichen Zusammenhang sie stehen.
