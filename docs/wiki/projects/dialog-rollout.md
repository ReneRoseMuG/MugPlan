...
| 5 | [Tags-Dialoge](../tasks/closed/tags-dialoge.md) | Abgeschlossen: Tag-Verwaltung, Termin-Tag-Picker und tagbezogene Notizdialoge nutzen gemeinsame Bestätigungs-, Shell- und Fehlerpfade. |
...
| 8 | [Reports- und Druck-Dialoge](../tasks/closed/reports-und-druck-dialoge.md) | Abgeschlossen: Overlays, Druckvorschau und Report-Fehlerkommunikation nutzen gemeinsame P-01-Strukturen. |
...
| 16 | [FT-04 gemeinsame Bestätigungs-Dialog-Basiskomponente](../tasks/closed/ft04-dialog-basiskomponente.md) | Abgeschlossen: gemeinsamer Ressourcenplanungsdialog für Vorschau, Auswahl, Bestätigung und Fehlerzustände. |
| 17 | [Tour-KW- und Termin-Mutationsdialoge](../tasks/closed/tour-kw-termin-mutationsdialoge.md) | Abgeschlossen: Tour-KW- und Terminressourcen nutzen den gemeinsamen Dialograhmen. |
| 18 | [FT-04 mehrstufiger Tour-KW-Dialog](../tasks/closed/ft04-multistep-tour-kw-dialog.md) | Abgeschlossen: Multistep-Flow sammelt Vorschauen und führt erst nach finaler Bestätigung seriell aus. |
| 19 | [FT-04 Multiselect für KW-Planung im Wochenkalender](../tasks/closed/ft04-multiselect-kw-planung-wochenkalender.md) | Abgeschlossen: Wochenkalender-Multiselect ist an den Ressourcenplanungsdialog angebunden. |
| 20 | [Termine- und Kalenderdialoge](../tasks/closed/termine-und-kalenderdialoge.md) | Abgeschlossen: Terminformular, Kalenderbewegungen und Ressourcenaktionen laufen über die gemeinsame Struktur. |
...
| 16 | FT-04 gemeinsame Bestätigungs-Dialog-Basiskomponente | Abgeschlossen am 11.05.26: `npm run check`, `npm run test:unit`, `npm run test:integration`, `npm run test:e2e`, gezielte Browser-E2E und `git diff --check` erfolgreich. |
| 17 | Tour-KW- und Termin-Mutationsdialoge | Abgeschlossen am 11.05.26: Ressourcenpreview für Tour-KW, Terminverschiebung, Kalenderbewegung und direkte Mitarbeiterpfade mit Unit-, Integration- und Browser-E2E abgesichert. |
| 18 | FT-04 mehrstufiger Tour-KW-Dialog | Abgeschlossen am 11.05.26: Multistep-Dialog, finale serielle Ausführung, Teilfehlerstatus und Tour-KW-Blockierbestätigung getestet. |
| 19 | FT-04 Multiselect für KW-Planung im Wochenkalender | Abgeschlossen am 11.05.26: Wochenkalender-Multiselect und Tour-KW-Form-Pfade per Browser-E2E geprüft. |
| 20 | Termine- und Kalenderdialoge | Abgeschlossen am 11.05.26: Terminformular, Drag-&-Drop, Markieren und Einfügen, direkte Terminmitarbeiter, Abwesenheiten und Reader-Readonly gezielt getestet. |
