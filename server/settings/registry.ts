...
export const userSettingsRegistry = {
  ...
  tourWeekPlanningLanesIsCollapsed: {
    ...
    description: "Steuert, ob die Tour-Lanes in der Tour-KW-Planung kollabiert sind.",
    type: "boolean",
    defaultValue: false,
    allowedScopes: ["USER"],
    validate: (value: unknown): value is boolean => typeof value === "boolean",
  },
  tourWeekPlanningLanesExpandedLaneId: {
    key: "tourWeekPlanning.weekLanes.expandedLaneId",
    label: "Tour-KW-Planung expandierte Lane",
    description: "Speichert die aktuell expandierte Lane-ID fuer den kollabierten Modus der Tour-KW-Planung.",
    type: "string",
    defaultValue: "",
    allowedScopes: ["USER"],
    placeholderWhitelist: [],
  ...
  calendarWeekInlineNotesVisible: {
    key: "calendar.weekInlineNotes.visible",
    label: "Wochenansicht Notizen sichtbar",
    description: "Steuert benutzerspezifisch, ob Notizen direkt an Terminkarten im Wochenkalender angezeigt werden.",
    type: "boolean",
    defaultValue: false,
    allowedScopes: ["USER"],
    validate: (value: unknown): value is boolean => typeof value === "boolean",
  },
  calendarWeekPersonnelColumnCollapsed: {
    key: "calendar.weekPersonnelColumn.collapsed",
    label: "Wochenansicht Personalspalte kollabiert",
    description: "Steuert benutzerspezifisch, ob die Personalspalte im Wochenkalender schmal oder erweitert dargestellt wird.",
    type: "boolean",
    defaultValue: true,
    allowedScopes: ["USER"],
    validate: (value: unknown): value is boolean => typeof value === "boolean",
