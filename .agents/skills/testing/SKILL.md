...
**Safety Gate (Pflicht vor jedem Lauf, AGENTS.md §12):**
...
**Nach expliziter Freigabe durch den Nutzer** gelten die vollen AGENTS.md §12-Regeln:
Isolationsklasse (`A`/`B`/`C`/`S`), Baseline (`core`/`seeded`), Storage-Bedarf, Testdaten-Tokens.

---

## MugPlan-Isolationsregeln für Integration-Tests (AGENTS.md §12)
